...
- Bio: `Edge Compounds`
- Total traded markets: `4467`
- Report scope: `weather_only`

## Completeness
- Raw trades fetched: `21703`
- Raw activity rows fetched: `22664`
- Distinct receipts fetched: `20964`
- Market contexts fetched: `5077`
- Ledger events rebuilt: `23649`
- Playbook sequences extracted: `1574`
- Strategy blueprints generated: `5`
- Backfill complete: `True`

## PnL Attribution
- Rebuilt realized PnL: `7270.92`
- Trade events: `20926`
- Merge events: `895`
- Redeem events: `48`
...
- `inventory_rebalancing_merge` status `ready_for_backtest`, confidence `0.99`, support `1083`, priority `260.08`: Accumulate both sides in the same condition when the reconstructed complete-set cost is below par, keep inventory roughly balanced, and exit by merging back into collateral.
- `neg_risk_basket` status `needs_exit_research`, confidence `0.94`, support `430`, priority `137.59`: Construct a same-side basket across sibling negative-risk markets when the basket cost is below a synthetic complete set, then monetize through event completion or later operational exits.
- `late_redemption_farming` status `operational_only`, confidence `0.91`, support `45`, priority `85.74`: Hold winning inventory through resolution and redeem directly, treating redemption as an operational exit path rather than alpha by itself.
...
## Replay Results
- Shadow trades: `20511`
- Slippage-free replay PnL: `-16837.38`
- Conservative replay PnL: `-25246.07`
